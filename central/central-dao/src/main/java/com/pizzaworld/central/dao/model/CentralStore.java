...
public class CentralStore extends AbstractAuditableEntity {
    ...
    public CentralStore(String name, String streetNumber, Street street, City city,PostCode postCode, String identifier, StoreStatus status) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        CentralStore that = (CentralStore) o;
